<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Speech to Text API engine. Examples: openai, togetherai, google, azure, watson, local.";
		$y++;
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "566ff14e-e28c-4ee5-b213-9287ba7ab463";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "transcribe";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "api_model";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Speech to Text API model. Example for Together AI: openai/whisper-large-v3.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "64aab693-e6d9-46b6-bb98-c96cad1eb7b6";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "transcribe";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "diarize";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Enable speaker diarization when supported by the provider.";
		$y++;
